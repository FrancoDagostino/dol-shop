...
const ProductAdminPage:FC<Props> = ({ product }) => {
    ...
    const onDeleteTag = ( newTag: string ) => {
        const currentTags = getValues('tags');
        setValue('tags',currentTags.filter(tag => tag !== newTag),{shouldValidate:true});
    }
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={ 6 }>
                        <TextField
                            ...
                            { ...register('slug', {
                                required: 'Este campo es requerido',
                                validate: (val) => val.trim().includes(' ') ? 'No puedetener espacion en blanco': undefined
                            })}
                            error={ !!errors.slug }
